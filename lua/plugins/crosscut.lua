...
-- cursor; `roots` and `flow` run it over the whole workspace (about 8 s warm on surfpool, the first
...
return {
  ...
  keys = {
    ...
    { '<leader>rnf', '<cmd>Crosscut flow<CR>', desc = 'Rust: navigate to the [F]low of the workspace' },
