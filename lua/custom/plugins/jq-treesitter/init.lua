...
local function show_floating_window(content, title, source_bufnr)
  ...
  local navigator = require('custom.plugins.jq-treesitter.navigator')
...
function M.setup(opts)
  ...
  -- Load debug commands
  require('custom.plugins.jq-treesitter.debug')
  ...
  vim.api.nvim_create_user_command('JqtQuery', function(args)
    ...
    local hybrid = require('custom.plugins.jq-treesitter.hybrid')
  ...
  vim.api.nvim_create_user_command('JqtMarkdownTable', function()
    local markdown = require('custom.plugins.jq-treesitter.markdown')
