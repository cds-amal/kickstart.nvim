...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- LSP progress handled by snacks.notifier
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- WARN: This is not Goto Definition, this is Goto Declaration.init
          ...
          -- Document highlight is handled by snacks.words (also adds ]] / [[ to jump between references)
